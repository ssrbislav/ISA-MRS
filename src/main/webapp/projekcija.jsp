...
<script type="text/javascript" src="js/jquery-3.2.1.js" ></script>
	<script type="text/javascript" src="js/dodaj_projekciju.js"></script>
</head>
<body>

<div style="margin: 0 auto; width: 300px;">
	<label style="color: #000066;">Popunite podatke o projekciji</label>
		<br>
		<br>
		<input name="naziv" placeholder="Naziv projekcije" size=50></input>
		...
		<br>
		<br>
		<button id="dodaj_projekciju">Dodaj Projekciju</button>
</div>
